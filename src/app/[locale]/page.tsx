...
export default async function HomePage({ params }: Props) {
  ...
  const searchIn =
    locale === "hy" ? "Որոնում · {city}" : locale === "en" ? "Search in {city}" : "Поиск в {city}";
    ...
    <div className="min-h-screen">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            inLanguage: locale === "hy" ? "hy-AM" : locale === "en" ? "en" : "ru-RU",
            potentialAction: {
              "@type": "SearchAction",
      ...
      <div className="md:hidden">
        ...
        <section className="px-3 pb-4">
          <HomeCategoryTiles categories={displayCategories} />
        </section>
      ...
      <div className="hidden md:block">
        ...
        <section className="px-4 mb-10 max-w-6xl mx-auto bg-[var(--bg-secondary)] py-8 rounded-[24px] animate-fade-up animate-delay-4">
