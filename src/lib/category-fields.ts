...
export const CATEGORY_FIELD_GROUPS: Record<string, CategoryFieldGroup[]> = {
  electronics: [
    {
      ...
      fields: [
        ...
        { key: "batteryHealth", label: "Состояние аккумулятора (%)", type: "number", min: 0, max: 100, showIf: { key: "subcategory", values: ["phone", "laptop", "tablet"] } },
        { key: "repaired", label: "Ремонтировался", type: "checkbox", showIf: { key: "subcategory", values: ["phone", "laptop", "tablet"] } },
        { key: "partsReplaced", label: "Менялись детали", type: "text", placeholder: "Экран, батарея...", showIf: { key: "subcategory", values: ["phone", "laptop"] } },
        { key: "faceId", label: "Face ID / Touch ID работает", type: "checkbox", showIf: { key: "subcategory", values: ["phone", "tablet"] } },
        { key: "imei", label: "IMEI", type: "text", showIf: { key: "subcategory", values: ["phone", "tablet"] } },
        { key: "kit", label: "Комплект", type: "text", placeholder: "Коробка, зарядка, наушники...", showIf: { key: "subcategory", values: ["phone", "laptop", "tablet", "audio"] } },
        { key: "cpu", label: "Процессор", type: "text", placeholder: "Intel i7, M3 Pro...", showIf: { key: "subcategory", values: ["laptop"] } },
        { key: "gpu", label: "Видеокарта", type: "text", showIf: { key: "subcategory", values: ["laptop"] } },
        { key: "ssd", label: "Накопитель (SSD/HDD)", type: "text", showIf: { key: "subcategory", values: ["laptop"] } },
        { key: "chargerIncluded", label: "Зарядник в комплекте", type: "checkbox", showIf: { key: "subcategory", values: ["laptop", "phone", "tablet"] } },
      ],
    },
  ],
  ...
  jobs: [
      ...
      fields: [
        {
          ...
          options: [
            ...
            { value: "resume", label: "Поиск работы" },
          ],
        },
      ],
    },
    {
      title: "Вакансия",
      fields: [
        { key: "company", label: "Компания", type: "text", required: true, placeholder: "Название компании", showIf: { key: "listingType", values: ["vacancy"] } },
        { key: "position", label: "Должность", type: "text", required: true, placeholder: "Менеджер, водитель...", showIf: { key: "listingType", values: ["vacancy"] } },
        {
          key: "employmentType",
          label: "Тип занятости",
          type: "select",
          showIf: { key: "listingType", values: ["vacancy"] },
          options: [
        ...
        { key: "salaryFrom", label: "Зарплата от (֏)", type: "number", min: 0, showIf: { key: "listingType", values: ["vacancy"] } },
        { key: "salaryTo", label: "Зарплата до (֏)", type: "number", min: 0, showIf: { key: "listingType", values: ["vacancy"] } },
        { key: "salaryNegotiable", label: "Зарплата по договорённости", type: "checkbox", showIf: { key: "listingType", values: ["vacancy"] } },
        { key: "duties", label: "Обязанности", type: "textarea", placeholder: "Опишите задачи", showIf: { key: "listingType", values: ["vacancy"] } },
        { key: "requirements", label: "Требования", type: "textarea", showIf: { key: "listingType", values: ["vacancy"] } },
        { key: "conditions", label: "Условия", type: "textarea", showIf: { key: "listingType", values: ["vacancy"] } },
        { key: "contactPerson", label: "Контактное лицо", type: "text", showIf: { key: "listingType", values: ["vacancy"] } },
      ],
    },
    {
      title: "Соискатель",
      fields: [
        { key: "position", label: "Желаемая должность", type: "text", required: true, showIf: { key: "listingType", values: ["resume"] } },
        { key: "salaryFrom", label: "Ожидаемая зарплата от (֏)", type: "number", min: 0, showIf: { key: "listingType", values: ["resume"] } },
        { key: "salaryTo", label: "Ожидаемая зарплата до (֏)", type: "number", min: 0, showIf: { key: "listingType", values: ["resume"] } },
        {
          key: "experience",
          label: "Опыт работы",
          type: "select",
          showIf: { key: "listingType", values: ["resume"] },
          options: [
        ...
        { key: "skills", label: "Навыки", type: "textarea", showIf: { key: "listingType", values: ["resume"] } },
        { key: "languages", label: "Языки", type: "text", placeholder: "Русский, английский...", showIf: { key: "listingType", values: ["resume"] } },
        { key: "education", label: "Образование", type: "textarea", showIf: { key: "listingType", values: ["resume"] } },
        { key: "relocation", label: "Готов к переезду", type: "checkbox", showIf: { key: "listingType", values: ["resume"] } },
        { key: "portfolio", label: "Портфолио / ссылки", type: "textarea", showIf: { key: "listingType", values: ["resume"] } },
      ],
    },
  ],
  ...
  services: [
    {
      ...
      fields: [
        ...
        { key: "pricePerHour", label: "Цена за час (֏)", type: "number", min: 0 },
        { key: "pricePerObject", label: "Цена за объект (֏)", type: "number", min: 0 },
        { key: "serviceDistrict", label: "Район обслуживания", type: "text", placeholder: "Ереван, Кентрон..." },
        { key: "urgentCall", label: "Срочный вызов", type: "checkbox" },
        { key: "certificates", label: "Сертификаты / лицензии", type: "text" },
        { key: "portfolioNote", label: "Фото работ (описание)", type: "textarea", placeholder: "Укажите в описании или прикрепите фото" },
      ],
    },
  ],
  ...
  "home-furniture": [
    {
      ...
      fields: [
        ...
        { key: "defects", label: "Дефекты", type: "text", placeholder: "Царапины, сколы..." },
  ...
  clothing: [
    {
      ...
      fields: [
        ...
        { key: "height", label: "Рост", type: "text", placeholder: "170–176 см" },
        { key: "material", label: "Материал", type: "text", placeholder: "Хлопок, шерсть..." },
        {
          key: "season",
          label: "Сезон",
          type: "select",
  ...
  kids: [
    {
      ...
      fields: [
        ...
        { key: "safetyStandard", label: "Безопасность / сертификаты", type: "text", placeholder: "EN71, ГОСТ..." },
        { key: "kitContents", label: "Комплектация", type: "text" },
        { key: "delivery", label: "Доставка возможна", type: "checkbox" },
        {
          key: "gender",
          label: "Для кого",
  ...
  animals: [
    {
      ...
      fields: [
        ...
        { key: "chip", label: "Чипирован", type: "checkbox" },
        { key: "petPassport", label: "Ветпаспорт", type: "checkbox" },
        { key: "character", label: "Характер", type: "text", placeholder: "Спокойный, активный..." },
        { key: "keepingConditions", label: "Условия содержания", type: "textarea" },
  ...
  "car-parts": [
    {
      ...
      fields: [
        ...
        { key: "compatibleWith", label: "Совместимые марки и модели", type: "text", placeholder: "Toyota Camry 2018–2022" },
        { key: "oem", label: "Оригинал (OEM)", type: "checkbox" },
        { key: "analog", label: "Аналог", type: "checkbox" },
        { key: "inStock", label: "В наличии", type: "checkbox" },
        { key: "warranty", label: "Гарантия", type: "checkbox" },
  ...
  trucks: [
    {
      ...
      fields: [
        ...
        { key: "weight", label: "Масса", type: "number", unit: "т" },
        { key: "engineHours", label: "Моточасы", type: "number", unit: "ч" },
        { key: "engineType", label: "Тип двигателя", type: "select", options: [
          { value: "diesel", label: "Дизель" },
          { value: "petrol", label: "Бензин" },
          { value: "electric", label: "Электро" },
          { value: "hybrid", label: "Гибрид" },
        ] },
        { key: "functions", label: "Функции / оборудование", type: "textarea" },
  ...
  "machinery-rental": [
    {
      ...
      fields: [
        ...
        { key: "rateHour", label: "Стоимость за час (֏)", type: "number", min: 0 },
        { key: "rateDay", label: "Стоимость за день (֏)", type: "number", min: 0 },
        { key: "rateWeek", label: "Стоимость за неделю (֏)", type: "number", min: 0 },
        { key: "rateMonth", label: "Стоимость за месяц (֏)", type: "number", min: 0 },
        { key: "minTerm", label: "Минимальный срок", type: "text", placeholder: "4 часа, 1 день..." },
        { key: "withOperator", label: "Оператор включён", type: "checkbox" },
        { key: "deposit", label: "Залог (֏)", type: "number", min: 0 },
  ...
  motorcycles: [
    {
      ...
      fields: [
        ...
        { key: "engineVolume", label: "Объём двигателя", type: "number", unit: "см³", showIf: { key: "motoType", values: ["motorcycle", "scooter", "atv", "moped", "snowmobile"] } },
        { key: "mileage", label: "Пробег", type: "number", unit: "км", showIf: { key: "motoType", values: ["motorcycle", "scooter", "atv", "moped", "snowmobile"] } },
        { key: "frameSize", label: "Размер рамы", type: "text", placeholder: "M, 54 см...", showIf: { key: "motoType", values: ["bicycle"] } },
        { key: "wheelSize", label: "Размер колёс", type: "text", placeholder: '26", 29"...', showIf: { key: "motoType", values: ["bicycle"] } },
        { key: "frameMaterial", label: "Материал рамы", type: "text", showIf: { key: "motoType", values: ["bicycle"] } },
        { key: "suspension", label: "Амортизация", type: "select", showIf: { key: "motoType", values: ["bicycle"] }, options: [
  ...
  "water-transport": [
    {
      ...
      fields: [
        ...
        { key: "width", label: "Ширина", type: "number", unit: "м", showIf: { key: "waterType", values: ["boat", "yacht", "kayak"] } },
        { key: "enginePower", label: "Мощность двигателя", type: "number", unit: "л.с.", showIf: { key: "waterType", values: ["boat", "yacht", "jet-ski", "motor"] } },
        { key: "hullMaterial", label: "Материал корпуса", type: "text", showIf: { key: "waterType", values: ["boat", "yacht", "kayak"] } },
...
export const REAL_ESTATE_EXTRA_FIELDS: CategoryField[] = [
  ...
  { key: "livingArea", label: "Жилая площадь (м²)", type: "number", min: 1 },
  { key: "kitchenArea", label: "Площадь кухни (м²)", type: "number", min: 1 },
  { key: "buildingMaterial", label: "Материал дома", type: "text", placeholder: "Кирпич, монолит, панель..." },
  { key: "airConditioning", label: "Кондиционер", type: "checkbox" },
  { key: "ceilingHeight", label: "Высота потолков (м)", type: "number", step: 0.1, min: 2 },
  {
  ...
  { key: "commercialPurpose", label: "Назначение (коммерческая)", type: "text" },
  { key: "landPurpose", label: "Назначение участка", type: "text", placeholder: "ИЖС, сельхоз, коммерция..." },
];
...
const VALUE_LABELS: Record<string, Record<string, string>> = {
  ...
  listingType: { vacancy: "Вакансия", resume: "Поиск работы" },
  commercialSubtype: {
    office: "Офис", warehouse: "Склад", garage: "Гараж",
    retail: "Торговое помещение", production: "Производство", other: "Другое",
  },
  suspension: { rigid: "Жёсткая", front: "Передняя", full: "Полная" },
  engineType: { diesel: "Дизель", petrol: "Бензин", electric: "Электро", hybrid: "Гибрид" },
  employmentType: {
  ...
  motoType: {
    ...
    snowmobile: "Снегоход", bicycle: "Велосипед", other: "Другое",
  },
  waterType: {
